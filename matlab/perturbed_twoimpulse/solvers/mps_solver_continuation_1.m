function [r1,rf2,v1_0,vf2,traj_t,traj_x]=mps_solver_continuation_1(r1,r2,v1_0,t1,t2,propagator,solverprops)
...
for epsilon=epsilon_vec
    err=1000;
    iter=1;
    delVvecs=solverprops.mps_1.get_delVs(solverprops.mps_1.Np,iter); % V=[... delv1 ...;
%                                         ... delv2 ...;...]

    while (err>solverprops.mps_1.tol)
        delVvecs=delVvecs*exp((1-iter)/(0.3*solverprops.mps_1.maxiter));
        [t,xref]=propagator([t1,t2],[r1;v1_0],epsilon);
        ...
        for i=1:size(delVvecs,1)
            v=v1_0+delVvecs(i,:)';
            [t,x]=propagator([t1,t2],[r1;v],epsilon);
        ...
        [t,x]=propagator([t1,t2],[r1,v1_0],epsilon);
        rf2=x(end,1:3)';
        vf2=x(end,4:6)';
        err=norm(r2-rf2);
%             [epsilon,iter,err]
